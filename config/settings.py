"""
Django settings for the AI Interview Assessment Platform.
...
# ─── File handling ────────────────────────────────────────────────────────────
TEMP_UPLOAD_DIR = os.getenv("TEMP_UPLOAD_DIR", "/tmp/interview_uploads")
# No MEDIA_ROOT — we never persist user files
